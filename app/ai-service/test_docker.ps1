...
# Show help function
function Show-Help {
    Write-Host "Usage: .\test_docker.ps1 [OPTIONS]"
    Write-Host ""
    Write-Host "Options:"
    ...
    Write-Host ""
    Write-Host "Examples:"
    Write-Host "  .\test_docker.ps1              # Run all tests"
    Write-Host "  .\test_docker.ps1 -Cleanup     # Clean up test containers"
    Write-Host "  .\test_docker.ps1 -Build       # Only test builds"
}
